...
static void uart_irq_handler(struct stm32_uart* uart)
{
    ...
    uart->rx_buffer[uart->save_index] = (rt_uint8_t)uart->uart_base->DR & 0xff;
    uart->save_index ++;
...
int rt_hw_usart_init(void)
{
#ifdef RT_USING_UART1
    {
        ...
        rt_device_register(&uart->parent, "uart1", RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX | RT_DEVICE_FLAG_STREAM);
    }
